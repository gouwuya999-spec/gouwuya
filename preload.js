...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  batchAddVps: async (vpsList) => {
    console.log('preload: 调用batchAddVps');
    return await ipcRenderer.invoke('batch-add-vps', vpsList);
  },
...
window.electronAPI = {
  ...
  batchAddVps: (vpsList) => ipcRenderer.invoke('batch-add-vps', vpsList),
