...
for ip in "${public_ips[@]}"; do
    ...
    echo "监听端口: ${WG_PORT}"
    echo "端口映射范围: ${MAP_PORT_START}-${MAP_PORT_END}"
...
echo "13. 保存脚本副本"
echo "----------------------------------------"
cp "$0" "$WG_DIR/增强版WireGuard部署脚本.sh"
echo "✅ 脚本副本已保存"
echo ""
...
echo "5. 端口映射范围: 55835-56834, 56835-57834"
echo ""
echo "如果连接后数据不通，请检查:"
